              ...
              <form class="g-py-15">
                ...
                <div class="mb-4">
                  <div class="input-group">
                    ...
                    <input class="form-control g-color-black g-brd-left-none g-brd-white g-bg-transparent g-color-white g-placeholder-white g-pl-0 g-pr-15 g-py-13" type="email" placeholder="nom d'utilisateur">
                  </div>
                </div>
                ...
                <div class="g-mb-40">
                  <div class="input-group rounded">
                    ...
                    <input class="form-control g-color-black g-brd-left-none g-brd-white g-bg-transparent g-color-white g-placeholder-white g-pl-0 g-pr-15 g-py-13" type="tel" placeholder="mot de passe">
                  </div>
                </div>

                <div class="g-mb-60">
                  <button class="btn btn-md btn-block u-btn-primary rounded text-uppercase g-py-13" type="button">Connexion</button>
                </div>
              ...
              <form class="g-py-15">
                ...
                <div class="mb-4">
                  <div class="input-group rounded">
                    ...
                    <input class="form-control g-color-black g-brd-left-none g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-pl-0 g-pr-15 g-py-13" type="email" placeholder="Votre nom">
                  </div>
                </div>
                ...
                <div class="mb-4">
                  <div class="input-group rounded">
                    ...
                    <input class="form-control g-color-black g-brd-left-none g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-pl-0 g-pr-15 g-py-13" type="email" placeholder="Nom d'utilisateur (Pseudo)">
                  </div>
                </div>
                ...
                <div class="mb-4">
                  <div class="input-group rounded">
                    ...
                    <input class="form-control g-color-black g-brd-left-none g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-pl-0 g-pr-15 g-py-13" type="email" placeholder="Votre email">
                  </div>
                </div>
                ...
                <div class="mb-4">
                  <div class="input-group rounded">
                    ...
                    <input class="form-control g-color-black g-brd-left-none g-bg-white g-bg-white--focus g-brd-gray-light-v4 g-pl-0 g-pr-15 g-py-13" type="tel" placeholder="Mot de passe">
                  </div>
                </div>
                ...
                <button class="btn btn-md btn-block u-btn-primary rounded text-uppercase g-py-13" type="button">Se connecter</button>
              </form>
              <!-- End Form -->
            </div>
          </div>
