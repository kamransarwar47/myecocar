...
class GoogleMapAPI
{
	...
	public function init() {
		...
		if ($this->includeJs === TRUE) {
			// Google map JS
			$this->content .= '<script type="text/javascript" src="https://maps.google.com/maps/api/js?sensor=false&language=' . $this->lang . '">';
			$this->content .= '</script>' . "\n";
		...
		$this->content .= "\t\t\t\t" . '} else {' . "\n";
		$this->content .= "\t\t\t\t" . 'console.log("Geocode was not successful for the following reason: " + status);' . "\n";
		$this->content .= "\t\t\t\t" . '}' . "\n";
		$this->content .= "\t\t\t" . '});' . "\n";
		$this->content .= "\t\t" . '}' . "\n";
		$this->content .= "\t" . '}' . "\n";
	...
	public function generate() {
		...
		$this->content .= "\t\t" . 'disableDefaultUI: false,' . "\n";
		$this->content .= "\t\t" . 'scrollwheel: false,' . "\n";
		$this->content .= "\t\t" . 'travelMode: google.maps.TravelMode.DRIVING,' . "\n";
