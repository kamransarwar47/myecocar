		...
		<div class="col-auto g-pos-rel">
		  <ul class="list-inline g-overflow-hidden g-pt-1 g-mx-minus-4 mb-0">
			...
			<li class="list-inline-item g-mx-4">
			  <a class="g-color-white g-color-primary--hover g-text-underline--none--hover" href="<?php echo base_url('login/logout'); ?>"><?php _l('logout'); ?></a>
			</li>
				<?php }else{ ?>
				<li class="list-inline-item g-mx-4">
			  <a class="g-color-white g-color-primary--hover g-text-underline--none--hover" href="<?php echo base_url('login'); ?>"><?php _l('header_connection'); ?></a>
			</li>
			<li class="list-inline-item g-mx-4">|</li>
			<li class="list-inline-item g-mx-4">
			  <a class="g-color-white g-color-primary--hover g-text-underline--none--hover" href="<?php echo base_url('registration'); ?>"><?php _l('header_register'); ?></a>
			</li>
				<?php } ?>
		  </ul>
		</div>
		...
		<div class="collapse navbar-collapse align-items-center flex-sm-row g-pt-10 g-pt-5--lg" id="navBar">
		  <ul class="navbar-nav text-uppercase g-font-weight-600 ml-auto">
			...
			<li class="nav-item g-mx-20--lg active">
			  <a href="<?php echo base_url('annonce'); ?>" class="nav-link px-0"><?php _l('header_route'); ?>
			<span class="sr-only"><?php _l('current'); ?></span>
		  </a>
			</li>
			<li class="nav-item g-mx-20--lg">
			  <a href="<?php echo base_url('research_trip'); ?>" class="nav-link px-0"><?php _l('header_search'); ?>
			
		  </a>
			</li>
			<li class="nav-item g-mx-20--lg">
			  <a href="<?php echo base_url('about'); ?>" class="nav-link px-0"><?php _l('header_who_we_are'); ?>
			 </a>
			</li>
		  </ul>
		</div>
