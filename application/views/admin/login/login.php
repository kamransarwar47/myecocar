...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo base_url(); ?>assets/img/admin/favicon-16x16.png" sizes="16x16">
    <link rel="icon" type="image/png" href="<?php echo base_url(); ?>assets/img/admin/favicon-32x32.png" sizes="32x32">
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/admin/login_page.min.css" />
...
<body class="login_page">
    ...
    <script src="<?php echo base_url(); ?>assets/js/admin/pages/login_page.min.js"></script>
